...
import Alert from '@mui/material/Alert'; // For Alert styling inside Snackbar
...
export default function SignIn(props: { disableCustomTheme?: boolean }) {
  ...
  const [snackbarOpen, setSnackbarOpen] = React.useState(false); // Snackbar visibility
  const [snackbarMessage, setSnackbarMessage] = React.useState(''); // Snackbar message
  const [snackbarSeverity, setSnackbarSeverity] = React.useState<'success' | 'error'>('error'); // Snackbar type
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSnackbarSeverity('error'); // Error message styling
